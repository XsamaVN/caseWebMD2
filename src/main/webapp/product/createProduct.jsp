...
<form method="post">
    <div class="input-group mb-3" style="width: 400px">
        ...
        <input type="number" name="idProduct" class="form-control" placeholder="Product ID" aria-label="Product ID"
    ...
    <div class="input-group mb-3" style="width: 400px">
        ...
        <input type="text" name="nameProduct" class="form-control" placeholder="Product Name" aria-label="Product Name"
               aria-describedby="basic-addon1">
    </div>
    <div class="input-group mb-3" style="width: 400px">
        <div class="input-group-prepend">
    ...
    <div class="input-group mb-3" style="width: 400px">
        ...
        <input type="number" name="priceProduct" class="form-control" placeholder="Product Price"
