...
<div class="container">
    <div class="row">
        ...
        <div class="col-8">
            <h1>Danh sách máy:</h1>
            <button class="btn btn-primary" style="margin-bottom: 20px"><a href="/pc?action=create" style="color: aliceblue">Tạo mới</a></button>
            <table class="table table-striped">
                ...
                <c:forEach items='${pcList}' var="pC">
                    <tr>
                        <td>${pC.idPC}</td>
                        <td>${pC.pricePC}</td>
                        <td><a href="/pc?action=editPC&idPC=${pC.idPC}">Sửa</a> </td>
                        <td><a href="/pc?action=deletePC&idPC=${pC.idPC}">Xóa</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
