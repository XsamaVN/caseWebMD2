...
<form method="post">
  ...
  <div class="input-group mb-3" style="width: 400px">
    ...
    <input type="text" name="userPassword"  class="form-control" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1">
  </div>
  <div class="input-group mb-3" style="width: 400px">
    <div class="input-group-prepend" >
      <span class="input-group-text"  style="width: 100px">Money</span>
    </div>
    <input type="number" name="moneCharge"  class="form-control" placeholder="Money" aria-label="Money" aria-describedby="basic-addon1">
  </div>
