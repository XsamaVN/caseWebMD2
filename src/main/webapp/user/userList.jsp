...
<div class="container">
    <div class="row">
        ...
        <div class="col-8">
            ...
            <button class="btn btn-primary" style="margin-bottom: 20px"><a href="/user?action=create" style="color: aliceblue">Tạo mới</a></button>
            <table class="table table-striped">
                ...
                <c:forEach items='${userList}' var="user">
                    <tr>
                        ...
                        <td>${user.moneyCharge}</td>
                        <td><a href="/user?action=editUser&id=${user.id}">Sửa</a></td>
                        <td><a href="/user?action=deleteUser&id=${user.id}">Xóa</a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
            <br>
            <button class="btn btn-primary"><a href="http://localhost:8080" style="color: aliceblue">Quay lại</a></button>
        </div>
    </div>
</div>
